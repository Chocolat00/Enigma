...
public class Main extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage stage) {
        ...
        l1 =new Label("Wybierz i zatwierdü ustawienia Enigmy aby rozpoczπÊ.");
        l1.setPrefWidth(400);
        //lista etykiet
        ...
        gridAnimation.add(new Label("Tu bÍdπ animacje"), 0, 0);
   ...
   private void closeProgram() {
   	 Alert alert = new Alert(AlertType.CONFIRMATION, "Czy na pewno chcesz zamknπÊ okno?", ButtonType.YES, ButtonType.NO);
   	 alert.showAndWait();
   ...
   void chooseRotors() {
	   if (first!=second && second!=third && third!=first) {
		   ...
		   l1.setText("Ustawienie wirnikÛw przebieg≥o prawid≥owo.\n");
	   }
	   else {
		   l1.setText("Conajmniej dwa wybrane wirniki sπ takie same. Nie moøna rozpoczπÊ.");
	   }
   }
   void setRotorPositions () {
	   if (rotor1!=null && rotor2!=null && rotor3!=null) {
		   ...
		   l1.setText(l1.getText()+"\nPozycja startowa wirnikÛw: "+pos1+" "+pos2+" "+pos3);
	   }
	   else {
		   l1.setText(l1.getText()+"\nNie ustawiono pozycji wirnikÛw. Nie moøna rozpoczπÊ.");
	   }
   }
